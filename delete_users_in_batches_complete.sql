-- =====================================================
-- PART 1: SETUP AND VARIABLE DECLARATIONS
-- =====================================================
-- This is Part 1 of the delete_users_in_batches stored procedure
-- Combine all parts in order to create the complete procedure
...
-- =====================================================
-- PART 2: BATCH PROCESSING LOOP AND ELIGIBILITY
-- =====================================================
-- This is Part 2 of the delete_users_in_batches stored procedure
    ...
    Outer_check: WHILE NOT done DO
        ...
        -- Update batch_id for pending records
        ...
        -- Mark users as 'in progress' if they meet eligibility criteria
        ...
        WHERE dui.batch_id = v_batch_id
            ...
            AND NOT EXISTS (
                SELECT 1 FROM v2_units vu WHERE vu.user_id = u.id
            )
            AND NOT EXISTS (
                SELECT 1 FROM auction a WHERE a.user_id = u.id
            )
            AND NOT EXISTS (
                SELECT 1 FROM prelets p WHERE p.user_id = u.id
            );
        
        -- Mark users as 'canceled' if they are owner or shared user in v2_shares
        UPDATE deleted_users_info dui
        INNER JOIN users u ON dui.user_id = u.id
        ...
        -- Populate temporary table with eligible users
...
-- =====================================================
-- PART 3: TABLE PROCESSING (Tables 1-10)
-- =====================================================
-- This is Part 3 of the delete_users_in_batches stored procedure

        -- Process unit_status_updates
        ...
        IF EXISTS (SELECT 1 FROM unit_status_updates usu INNER JOIN temp_user_ids t ON usu.user_id = t.user_id LIMIT 1) THEN
            ...
            SELECT usu.* FROM unit_status_updates usu INNER JOIN temp_user_ids t ON usu.user_id = t.user_id;
            ...
            WHERE EXISTS (SELECT 1 FROM temp_user_ids t WHERE t.user_id = usu.user_id)
                AND EXISTS (SELECT 1 FROM archived_data.unit_status_updates_archived a WHERE a.id = usu.id);
        ...
        IF EXISTS (SELECT 1 FROM unit_overrides uo INNER JOIN temp_user_ids t ON uo.user_id = t.user_id LIMIT 1) THEN
            ...
            SELECT uo.* FROM unit_overrides uo INNER JOIN temp_user_ids t ON uo.user_id = t.user_id;
            ...
            WHERE EXISTS (SELECT 1 FROM temp_user_ids t WHERE t.user_id = uo.user_id)
                AND EXISTS (SELECT 1 FROM archived_data.unit_overrides_archived a WHERE a.id = uo.id);
        ...
        IF EXISTS (SELECT 1 FROM transfer tr INNER JOIN temp_user_ids t ON tr.user_id = t.user_id LIMIT 1) THEN
            ...
            SELECT tr.* FROM transfer tr INNER JOIN temp_user_ids t ON tr.user_id = t.user_id;
            ...
            WHERE EXISTS (SELECT 1 FROM temp_user_ids t WHERE t.user_id = tr.user_id)
                AND EXISTS (SELECT 1 FROM archived_data.transfer_archived a WHERE a.id = tr.id);
        ...
        IF EXISTS (SELECT 1 FROM support_activity sa INNER JOIN temp_user_ids t ON sa.user_id = t.user_id LIMIT 1) THEN
            ...
            SELECT sa.* FROM support_activity sa INNER JOIN temp_user_ids t ON sa.user_id = t.user_id;
            ...
            WHERE EXISTS (SELECT 1 FROM temp_user_ids t WHERE t.user_id = sa.user_id)
                AND EXISTS (SELECT 1 FROM archived_data.support_activity_archived a WHERE a.id = sa.id);
        ...
        IF EXISTS (SELECT 1 FROM unlock_override_pins uop INNER JOIN temp_user_ids t ON uop.user_id = t.user_id LIMIT 1) THEN
            ...
            SELECT uop.* FROM unlock_override_pins uop INNER JOIN temp_user_ids t ON uop.user_id = t.user_id;
            ...
            WHERE EXISTS (SELECT 1 FROM temp_user_ids t WHERE t.user_id = uop.user_id)
                AND EXISTS (SELECT 1 FROM archived_data.unlock_override_pins_archived a WHERE a.id = uop.id);
        ...
        IF EXISTS (SELECT 1 FROM user_acknowledgement ua INNER JOIN temp_user_ids t ON ua.user_id = t.user_id LIMIT 1) THEN
            ...
            SELECT ua.* FROM user_acknowledgement ua INNER JOIN temp_user_ids t ON ua.user_id = t.user_id;
            ...
            WHERE EXISTS (SELECT 1 FROM temp_user_ids t WHERE t.user_id = ua.user_id)
                AND EXISTS (SELECT 1 FROM archived_data.user_acknowledgement_archived a WHERE a.id = ua.id);
        ...
        IF EXISTS (SELECT 1 FROM user_login_history ulh INNER JOIN temp_user_ids t ON ulh.user_id = t.user_id LIMIT 1) THEN
            ...
            SELECT ulh.* FROM user_login_history ulh INNER JOIN temp_user_ids t ON ulh.user_id = t.user_id;
            ...
            WHERE EXISTS (SELECT 1 FROM temp_user_ids t WHERE t.user_id = ulh.user_id)
                AND EXISTS (SELECT 1 FROM archived_data.user_login_history_archived a WHERE a.id = ulh.id);
        ...
        IF EXISTS (SELECT 1 FROM user_site_bookmarks usb INNER JOIN temp_user_ids t ON usb.user_id = t.user_id LIMIT 1) THEN
            ...
            SELECT usb.* FROM user_site_bookmarks usb INNER JOIN temp_user_ids t ON usb.user_id = t.user_id;
            ...
            WHERE EXISTS (SELECT 1 FROM temp_user_ids t WHERE t.user_id = usb.user_id)
                AND EXISTS (SELECT 1 FROM archived_data.user_site_bookmarks_archived a WHERE a.id = usb.id);
        ...
        IF EXISTS (SELECT 1 FROM users_dashboard ud INNER JOIN temp_user_ids t ON ud.user_id = t.user_id LIMIT 1) THEN
            ...
            SELECT ud.* FROM users_dashboard ud INNER JOIN temp_user_ids t ON ud.user_id = t.user_id;
            ...
            WHERE EXISTS (SELECT 1 FROM temp_user_ids t WHERE t.user_id = ud.user_id)
                AND EXISTS (SELECT 1 FROM archived_data.users_dashboard_archived a WHERE a.id = ud.id);
...
-- =====================================================
-- PART 4: TABLE PROCESSING (Tables 11-20)
-- =====================================================
-- This is Part 4 of the delete_users_in_batches stored procedure

        -- Process users_notifications_settings
        ...
        IF EXISTS (SELECT 1 FROM users_notifications_settings uns INNER JOIN temp_user_ids t ON uns.user_id = t.user_id LIMIT 1) THEN
            ...
            SELECT uns.* FROM users_notifications_settings uns INNER JOIN temp_user_ids t ON uns.user_id = t.user_id;
            ...
            WHERE EXISTS (SELECT 1 FROM temp_user_ids t WHERE t.user_id = uns.user_id)
                AND EXISTS (SELECT 1 FROM archived_data.users_notifications_settings_archived a WHERE a.id = uns.id);
        ...
        IF EXISTS (SELECT 1 FROM users_zone_triggers uzt INNER JOIN temp_user_ids t ON uzt.user_id = t.user_id LIMIT 1) THEN
            ...
            SELECT uzt.* FROM users_zone_triggers uzt INNER JOIN temp_user_ids t ON uzt.user_id = t.user_id;
            ...
            WHERE EXISTS (SELECT 1 FROM temp_user_ids t WHERE t.user_id = uzt.user_id)
                AND EXISTS (SELECT 1 FROM archived_data.users_zone_triggers_archived a WHERE a.id = uzt.id);
        ...
        IF EXISTS (SELECT 1 FROM v2_app_details vad INNER JOIN temp_user_ids t ON vad.user_id = t.user_id LIMIT 1) THEN
            ...
            SELECT vad.* FROM v2_app_details vad INNER JOIN temp_user_ids t ON vad.user_id = t.user_id;
            ...
            WHERE EXISTS (SELECT 1 FROM temp_user_ids t WHERE t.user_id = vad.user_id)
                AND EXISTS (SELECT 1 FROM archived_data.v2_app_details_archived a WHERE a.id = vad.id);
        ...
        IF EXISTS (SELECT 1 FROM v2_tracking_ids vti INNER JOIN temp_user_ids t ON vti.user_id = t.user_id LIMIT 1) THEN
            ...
            SELECT vti.* FROM v2_tracking_ids vti INNER JOIN temp_user_ids t ON vti.user_id = t.user_id;
            ...
            WHERE EXISTS (SELECT 1 FROM temp_user_ids t WHERE t.user_id = vti.user_id)
                AND EXISTS (SELECT 1 FROM archived_data.v2_tracking_ids_archived a WHERE a.id = vti.id);
        ...
        IF EXISTS (SELECT 1 FROM watch_users wu INNER JOIN temp_user_ids t ON wu.user_id = t.user_id LIMIT 1) THEN
            ...
            SELECT wu.* FROM watch_users wu INNER JOIN temp_user_ids t ON wu.user_id = t.user_id;
            ...
            WHERE EXISTS (SELECT 1 FROM temp_user_ids t WHERE t.user_id = wu.user_id)
                AND EXISTS (SELECT 1 FROM archived_data.watch_users_archived a WHERE a.id = wu.id);
        ...
        -- Process 2_factor_auth_pin
        SET v_tab_name = '2_factor_auth_pin';
        IF EXISTS (SELECT 1 FROM 2_factor_auth_pin tfap INNER JOIN temp_user_ids t ON tfap.user_id = t.user_id LIMIT 1) THEN
            INSERT INTO archived_data.2_factor_auth_pin_archived
            SELECT tfap.* FROM 2_factor_auth_pin tfap INNER JOIN temp_user_ids t ON tfap.user_id = t.user_id;
            ...
            DELETE tfap FROM 2_factor_auth_pin tfap
            WHERE EXISTS (SELECT 1 FROM temp_user_ids t WHERE t.user_id = tfap.user_id)
                AND EXISTS (SELECT 1 FROM archived_data.2_factor_auth_pin_archived a WHERE a.id = tfap.id);
        ...
        IF EXISTS (SELECT 1 FROM access_codes ac INNER JOIN temp_user_ids t ON ac.user_id = t.user_id LIMIT 1) THEN
            ...
            SELECT ac.* FROM access_codes ac INNER JOIN temp_user_ids t ON ac.user_id = t.user_id;
            ...
            WHERE EXISTS (SELECT 1 FROM temp_user_ids t WHERE t.user_id = ac.user_id)
                AND EXISTS (SELECT 1 FROM archived_data.access_codes_archived a WHERE a.id = ac.id);
        ...
        IF EXISTS (SELECT 1 FROM devices d INNER JOIN temp_user_ids t ON d.user_id = t.user_id LIMIT 1) THEN
            ...
            SELECT d.* FROM devices d INNER JOIN temp_user_ids t ON d.user_id = t.user_id;
            ...
            WHERE EXISTS (SELECT 1 FROM temp_user_ids t WHERE t.user_id = d.user_id)
                AND EXISTS (SELECT 1 FROM archived_data.devices_archived a WHERE a.id = d.id);
        ...
        IF EXISTS (SELECT 1 FROM digital_audits da INNER JOIN temp_user_ids t ON da.user_id = t.user_id LIMIT 1) THEN
            ...
            SELECT da.* FROM digital_audits da INNER JOIN temp_user_ids t ON da.user_id = t.user_id;
            ...
            WHERE EXISTS (SELECT 1 FROM temp_user_ids t WHERE t.user_id = da.user_id)
                AND EXISTS (SELECT 1 FROM archived_data.digital_audits_archived a WHERE a.id = da.id);
...
-- =====================================================
-- PART 5: TABLE PROCESSING (Tables 21-29 and users)
-- =====================================================
-- This is Part 5 of the delete_users_in_batches stored procedure

        -- Process entry_activity
        ...
        IF EXISTS (SELECT 1 FROM entry_activity ea INNER JOIN temp_user_ids t ON ea.user_id = t.user_id LIMIT 1) THEN
            ...
            SELECT ea.* FROM entry_activity ea INNER JOIN temp_user_ids t ON ea.user_id = t.user_id;
            ...
            WHERE EXISTS (SELECT 1 FROM temp_user_ids t WHERE t.user_id = ea.user_id)
                AND EXISTS (SELECT 1 FROM archived_data.entry_activity_archived a WHERE a.id = ea.id);
        ...
        IF EXISTS (SELECT 1 FROM permissions p INNER JOIN temp_user_ids t ON p.user_id = t.user_id LIMIT 1) THEN
            ...
            SELECT p.* FROM permissions p INNER JOIN temp_user_ids t ON p.user_id = t.user_id;
            ...
            WHERE EXISTS (SELECT 1 FROM temp_user_ids t WHERE t.user_id = p.user_id)
                AND EXISTS (SELECT 1 FROM archived_data.permissions_archived a WHERE a.id = p.id);
        ...
        IF EXISTS (SELECT 1 FROM pending_notifications pn INNER JOIN temp_user_ids t ON pn.user_id = t.user_id LIMIT 1) THEN
            ...
            SELECT pn.* FROM pending_notifications pn INNER JOIN temp_user_ids t ON pn.user_id = t.user_id;
            ...
            WHERE EXISTS (SELECT 1 FROM temp_user_ids t WHERE t.user_id = pn.user_id)
                AND EXISTS (SELECT 1 FROM archived_data.pending_notifications_archived a WHERE a.id = pn.id);
        ...
        IF EXISTS (SELECT 1 FROM oauth_session_store oss INNER JOIN temp_user_ids t ON oss.user_id = t.user_id LIMIT 1) THEN
            ...
            SELECT oss.* FROM oauth_session_store oss INNER JOIN temp_user_ids t ON oss.user_id = t.user_id;
            ...
            WHERE EXISTS (SELECT 1 FROM temp_user_ids t WHERE t.user_id = oss.user_id)
                AND EXISTS (SELECT 1 FROM archived_data.oauth_session_store_archived a WHERE a.id = oss.id);
        ...
        IF EXISTS (SELECT 1 FROM note_comments nc INNER JOIN temp_user_ids t ON nc.user_id = t.user_id LIMIT 1) THEN
            ...
            SELECT nc.* FROM note_comments nc INNER JOIN temp_user_ids t ON nc.user_id = t.user_id;
            ...
            WHERE EXISTS (SELECT 1 FROM temp_user_ids t WHERE t.user_id = nc.user_id)
                AND EXISTS (SELECT 1 FROM archived_data.note_comments_archived a WHERE a.id = nc.id);
        ...
        -- Process invalid_entry_attempts
        ...
        IF EXISTS (SELECT 1 FROM invalid_entry_attempts iea INNER JOIN temp_user_ids t ON iea.user_id = t.user_id LIMIT 1) THEN
            ...
            SELECT iea.* FROM invalid_entry_attempts iea INNER JOIN temp_user_ids t ON iea.user_id = t.user_id;
            ...
            WHERE EXISTS (SELECT 1 FROM temp_user_ids t WHERE t.user_id = iea.user_id)
                AND EXISTS (SELECT 1 FROM archived_data.invalid_entry_attempts_archived a WHERE a.id = iea.id);
        ...
        IF EXISTS (SELECT 1 FROM users_roles ur INNER JOIN temp_user_ids t ON ur.user_id = t.user_id LIMIT 1) THEN
            ...
            SELECT ur.* FROM users_roles ur INNER JOIN temp_user_ids t ON ur.user_id = t.user_id;
            ...
            WHERE EXISTS (SELECT 1 FROM temp_user_ids t WHERE t.user_id = ur.user_id)
                AND EXISTS (SELECT 1 FROM archived_data.users_roles_archived a WHERE a.id = ur.id);
        ...
        -- Process users (main table - deleted last)
        ...
        IF EXISTS (SELECT 1 FROM users u INNER JOIN temp_user_ids t ON u.id = t.user_id LIMIT 1) THEN
            ...
            SELECT u.* FROM users u INNER JOIN temp_user_ids t ON u.id = t.user_id;
...
-- =====================================================
-- PART 6: COMPLETION AND CLEANUP
-- =====================================================
-- This is Part 6 (final part) of the delete_users_in_batches stored procedure
